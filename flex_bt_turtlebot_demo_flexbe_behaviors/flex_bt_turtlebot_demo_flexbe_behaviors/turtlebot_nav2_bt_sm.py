...
@author: Josh Zutell
'''
class TurtlebotNav2BTSM(Behavior):
	'''
	...
	def __init__(self, node):
		super(TurtlebotNav2BTSM, self).__init__()
		self.name = 'Turtlebot Flex Nav BT'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('Navigate',
										BtExecuteGoalState(bt_topic="bt_executor", bt_file="flex_bt_turtlebot_demo_bringup/behavior_trees/nav2_navigate_to_pose.xml", goal_id="goal"),
