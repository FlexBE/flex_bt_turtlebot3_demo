...
class TurtlebotNav2MultiBTsSM(Behavior):
	...
	def __init__(self, node):
		...
		self.name = 'Turtlebot Nav2 Multi-BTs'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('PlanPath',
										BtExecuteGoalState(bt_topic="bt_executor", bt_file="flex_bt_turtlebot_demo_bringup/behavior_trees/nav2_plan_path.xml", goal_id="goal", goal_msg_type="PoseStamped", request_id="", request_msg_pkg="", request_msg_type=""),
