...
from flex_bt_turtlebot3_demo_flexbe_states.charging_state import ChargingState
from flex_bt_turtlebot3_demo_flexbe_states.check_battery_life_state import CheckBatteryLifeState
from flex_bt_turtlebot3_demo_flexbe_states.get_waypoints_state import GetWaypointsState
from flex_bt_turtlebot3_demo_flexbe_states.send_waypoints_state import SendWaypointsState
...
@author: Josh Zutell
'''
class Turtlebot3PatrolSM(Behavior):
	'''
	...
	def __init__(self, node):
		super(Turtlebot3PatrolSM, self).__init__()
		self.name = 'Turtlebot3 Patrol'
	...
	def create(self):
		...
		with _sm_setupbehavior_0:
			...
			OperatableStateMachine.add('LoadBTs',
										BtLoaderState(bt_topic="bt_loader", filepaths=["flex_bt_turtlebot3_demo_bringup/behavior_trees/nav2_plan_path.xml", "flex_bt_turtlebot3_demo_bringup/behavior_trees/nav2_navigate_w_battery_check.xml", "flex_bt_turtlebot3_demo_bringup/behavior_trees/nav2_recovery_fallback.xml", "flex_bt_turtlebot3_demo_bringup/behavior_trees/nav2_navigate_to_pose.xml"], timeout=5.0),
		...
		with _sm_navigate_1:
			...
			OperatableStateMachine.add('FollowPath',
										BtExecuteGoalState(bt_topic="bt_executor", bt_file="flex_bt_turtlebot3_demo_bringup/behavior_trees/nav2_navigate_w_battery_check.xml", goal_id="min_battery", goal_msg_type="double", request_id="battery_percentage", request_msg_pkg="", request_msg_type="double"),
		...
		with _sm_patrol_2:
			...
			OperatableStateMachine.add('Plan',
										BtExecuteGoalState(bt_topic="bt_executor", bt_file="flex_bt_turtlebot3_demo_bringup/behavior_trees/nav2_plan_path.xml", goal_id="goal", goal_msg_type="PoseStamped", request_id="path", request_msg_pkg="nav_msgs", request_msg_type="Path"),
		...
		with _state_machine:
			...
			OperatableStateMachine.add('Recovery',
										BtExecuteState(bt_topic="bt_executor", bt_file="flex_bt_turtlebot3_demo_bringup/behavior_trees/nav2_recovery_fallback.xml"),
